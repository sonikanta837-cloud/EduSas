...
class CertificateControllerTest {
    ...
    @Test
    @WithMockUser(roles = "HR")
    void getAllCertificates_asHr_returns200() throws Exception {
        // CertificateController allows ADMIN, DIRECTOR, and HR on GET /api/certificates —
        // HR is not forbidden here.
        when(certificateService.getAllCertificates()).thenReturn(List.of(sampleCertDto));
