...
import com.emp.management.service.CorrectionNotificationService;
...
@RestController
@RequestMapping("/api/correction-notifications")
@RequiredArgsConstructor
public class CorrectionNotificationController {

    private final CorrectionNotificationService service;

    @GetMapping("/unread")
    public List<CorrectionNotificationDTO> getUnread(@AuthenticationPrincipal UserDetails principal) {
